    ...
    return (
      <div>
        ...
        <Card>
          ...
          <DropdownMenu>
            <DropdownItem onClick={() => this.selectOption('Option 1')}>Category 1</DropdownItem>
            <DropdownItem onClick={() => this.selectOption('Option 2')}>Category 2</DropdownItem>
            <DropdownItem onClick={() => this.selectOption('Option 3')}>Category 3</DropdownItem>
          </DropdownMenu>
        </Dropdown>
                </Col>
                <Col lg="6" md="6" sm="6" className="mb-2">
